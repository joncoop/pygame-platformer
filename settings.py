...
# Images
''' hero '''
HERO_IMGS_IDLE_RIGHT = ['assets/images/characters/player_idle.png']
HERO_IMGS_WALK_RIGHT = ['assets/images/characters/player_walk1.png',
                        'assets/images/characters/player_walk2.png']
HERO_IMGS_JUMP_RIGHT = ['assets/images/characters/player_jump.png']
...
SPIKEMAN_IMG_WALK_RIGHT = ['assets/images/characters/spikeman_walk1.png',
